...
dVdt = @(V, n, m, h, I, Na_O, K_O, P_O, L_O) (I - K_O*I_K(V,n) - ...
    Na_O*I_Na(V,m,h) - L_O*I_L(V) + P_O*I_P) / C_M;
...
dKdt = @(V, n, K_O, P_O, L_O) -I_K(V,n)*K_O - L_O*I_L(V) - 2*P_O*I_P;
...
for i=1:num_iterations
    ...
    dK1 = dKdt(V(i)      , n(i)                  , K_O, P_O, L_O)*dt;
    ...
    dK2 = dKdt(V(i)+dV1/2, n(i)+dN1/2            , K_O, P_O, L_O)*dt;
    ...
    dK3 = dKdt(V(i)+dV2/2, n(i)+dN2/2            , K_O, P_O, L_O)*dt;
    ...
    dK4 = dKdt(V(i)+dV3  , n(i)+dN3              , K_O, P_O, L_O)*dt;
